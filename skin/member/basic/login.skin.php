...
<!-- 로그인 시작 { -->
<div id="mb_login" class="mb_default mbskin">
  <div class="container">
    <div class="wrapper">
      <div class="mb_default_ct mbskin_box">
        ...
        <form name="flogin" action="<?php echo $login_action_url ?>" onsubmit="return flogin_submit(this);" method="post">
          ...
          <fieldset id="login_fs">
            ...
            <input type="text" name="mb_id" id="login_id" required class="fm-input full required" size="20" maxLength="20" placeholder="아이디를 입력해주세요.">
            <label for="login_pw" class="sound_only">비밀번호<strong class="sound_only"> 필수</strong></label>
            <input type="password" name="mb_password" id="login_pw" required class="fm-input full required" size="20" maxLength="20" placeholder="비밀번호를 입력해주세요.">
            
            <div class="mbskin_btn_box">
              <button type="submit" class="i-btn1 full">로그인 하기</button>
            </div>
